<template>
  <div id="app">
    ...
    <div class="card">
      ...
      <Alert
        alertType="warning"
        alertPosition="global"
        :isActive="this.warnActive"
        :persistFor="5"
      >Warning Message Goes Here</Alert>
      <h1>Quantity Selector</h1>
      <div class="card-text">6 configirable properties
        <ol>
          <li>
            count - Default value
            <strong>1</strong>
          ...
          <li>
            maxCount - Default value
            <strong>6</strong>
          </li>
          <li>
            isCountEditable - Default value
            <strong>true</strong>
          </li>
          <li>
            iconDimensions - Default value
            <strong>15</strong>
          </li>
          <li>
            minusIconFillColor - Default value
            <strong>#000</strong>
          </li>
          <li>
            plusIconFillColor - Default value
            <strong>#000</strong>
          </li>
        </ol>
      </div>
      <p class="card-text">
        Count of the component is emitted to the parent copmponent using a custom event
        <strong
      ...
      <div class="card-text">
        ...
        <QuantitySelector
          ...
          :maxCount="10"
          :iconDimensions="15"
          minusIconFillColor="red"
          plusIconFillColor="green"
        />
      </div>
      <div class="card-text">
      ...
      <div class="card-text">
        <h4>Emit the quantity from component to parent component when tha parent needs to know about the selected quantity.</h4>
    ...
    <div class="card">
      <h1>Star Rating</h1>
      <div class="card-text">7 configirable properties
        <ol>
          <li>rating - There is no default value.</li>
          <li>
            totalStars - Default value
            <strong>5</strong>
          </li>
          <li>
            iconDimensions - Default value
          ...
          <li>
            baseColor - Default value
            <strong>#CCC</strong>
          </li>
          <li>
            fillColor - Default value
            <strong>#42b983</strong>
          </li>
          <li>
            noRatingMsg - Default value
      ...
      <div class="card-text">
        ...
        <Alert
          :isActive="this.inlineWarnActive"
          alertType="warning"
    ...
    <div class="card">
      <h1>Grid</h1>
      <div class="card-text">Just 1 configirable property
        <ol>
          <li>
            columns - Default value is an object
            <strong>
              <code>
                {
                xs: 2,
        ...
        <span style="color: red;">
          <strong>Note:</strong> The dashed border in the Grid items is only part of the demo!
        </span>
      </div>
      <div class="card-text">
        ...
        <Grid>
          <GridItem v-for="(item, index) in gridData" :key="index">
            <p>Product Name can go here!</p>
            <StarRating :rating="item.rating"/>
            <p>Product Description can go here!</p>
          </GridItem>
        </Grid>
      </div>
      <div class="card-text">
    ...
    <div class="card">
      <h1>Alert</h1>
      <div class="card-text">4 configirable property
        <ol>
          <li>
      ...
      <div class="card-text">
        <h4>Default</h4>
        <p>In a real world use case, some sort of an action will invoke the global error or warning.
          <br>For this demo, the button click will invoke the alert!
        </p>
      ...
      <div class="card-text">
        ...
        <p>Persistance of the error message signifies the time for which the alert will be shown and then it will disappear!
          <br>The time is expected in seconds! The component will convert it to milli-seconds.
        </p>
        <button
          @click="setWarnActive"
        >{{this.warnActive ? 'Hide Global Warning' : 'Show Global Warning'}}</button>
      </div>
      <div class="card-text">
        <h4>Inline field-level error alert</h4>
        <p>In real world scenarios, a filed level error can be shown when client-side validations are done!</p>
        <button
          @click="setInlineErrorActive"
        >{{this.inlineErrorActive ? 'Hide Inline Error' : 'Show Inline Error'}}</button>
      </div>
      <div class="card-text">
        <h4>Inline field-level warning alert</h4>
        <p>In real world scenarios, a filed level warning can be shown when client-side validations are done. Warnings are usually shown and then disappear after a certain time duration.</p>
        <button
          @click="setInlineWarnActive"
        >{{this.inlineWarnActive ? 'Hide Inline Warning' : 'Show Inline Warning'}}</button>
      </div>
    </div>
    <div class="card">
      <h1>Bag Count</h1>
      <div class="card-text">6 configirable properties
        <ol>
          ...
          <li>
            ...
            <strong>M177.91,55.377h-22.589v-1.368C155.311,24.25,131.091,0,101.302,0C71.503,0,47.292,24.25,47.292,54.009v1.368H24.704L11.495,202.614h179.624L177.91,55.377L177.91,55.377z M101.302,6.624c19.687,0,36.619,12.105,43.761,29.232c-9.448-14.137-25.5-23.478-43.761-23.478c-18.231,0-34.313,9.34-43.77,23.507C64.713,18.729,81.635,6.624,101.302,6.624z M57.297,55.377c4.406-20.263,22.481-35.485,44.024-35.485c21.582,0,39.618,15.222,44.024,35.485H57.297z</strong>
          </li>
          <li>
            fillColor - Default value
            <strong>#42b983</strong>
      ...
      <div class="card-text">
        ...
        <BagCount
          iconPath="M166.089,42.803h-37.671V28.026C128.418,12.573,115.849,0,100.396,0S72.37,12.573,72.37,28.026
    ...
    <div class="card">
      <h1>Variance Selector</h1>
      <div class="card-text">4 configurable properties
        <ol>
          <li>
      ...
      <p class="card-text">
        Selected value of the variance component is emitted to the parent copmponent using a custom event
        <strong
          class="highlight-text"
        >get-selected-variant</strong>
      </p>
      <div class="card-text">
        <h4>Default (Size Picker)</h4>
        <VarianceSelector
          labelName="Size"
          labelDefaultValue="Please select a size"
          :varianceData="sizeSelectorData"
        />
      </div>
      <div class="card-text">
        ...
        <VarianceSelector
          labelName="Color"
          labelDefaultValue="Please select a color"
          :varianceData="colorSelectorData"
          shape="circle"
        />
      </div>
      <div class="card-text">
        <h4>Default (Quantity Selector)</h4>
        <p>Use-case when you have a product sold in bulk, like print paper or visiting cards!</p>
        <VarianceSelector
          labelName="Quantity"
          labelDefaultValue="Please select quantity"
          :varianceData="quantitySelectorData"
        />
      </div>
      <div class="card-text">
        ...
        <VarianceSelector
          labelName="Size"
          labelDefaultValue="Please select a size"
          :varianceData="singleSizeData"
        />
      </div>
      <div class="card-text">
        <h4>Emit the selected variant value from component to parent component when tha parent needs to know about the selected value.</h4>
        <div class="compo-label">
        ...
        <VarianceSelector
          ...
          labelDefaultValue="Please select a size"
          :varianceData="sizeSelectorData"
          @get-selected-variant="passVariantVal"
        />
      </div>
    </div>
    <div class="card">
      <h1>Scroll To Top</h1>
      <div class="card-text">4 configirable properties
        <ol>
          <li>
            iconDimensions - Default value
            <strong>20</strong>
          ...
          <li>
            iconPath - Default value
            <strong>M5.906,34.998c-1.352,1.338-3.541,1.338-4.893,0c-1.35-1.338-1.352-3.506,0-4.846l19.54-19.148c1.352-1.338,3.543-1.338,4.895,0l19.539,19.148c1.352,1.34,1.352,3.506,0,4.846c-1.352,1.338-3.541,1.338-4.893,0L23,19.295L5.906,34.998z</strong>
          </li>
          <li>
            iconViewBox - Default value
            <strong>0 0 46.001 46.001</strong>
          </li>
          <li>
            fillColor - Default value
            <strong>#42b983</strong>
      ...
      colorSelectorData: [
        {
          name: "Black/Red",
          value: "XS",
          image: { background: swatchImg, position: "-0px 0" }
        },
        {
          name: "Black/Pink",
          value: "S",
        ...
        {
          name: "Black/Tan/Purple",
          value: "L",
          image: { background: swatchImg, position: "-168px 0" }
        },
        {
          name: "Magnta Multi",
          value: "XL",
          image: { background: swatchImg, position: "-224px 0" }
        }
      ],
